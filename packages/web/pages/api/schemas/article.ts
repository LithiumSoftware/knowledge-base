...
export const resolvers = {
  ...
  Mutation: {
            ...
            db.article_modification
              ...
              .then(articleModification => {
                ...
                if (
                  ...
                  moment(articleModification.dataValues.updatedAt).isSame(moment(), "minute")
                ) {
                  return articleModification.update(updatedData).then(() => updated);
                } else {
                  return db.article_modification.create(updatedData).then(() => updated);
                }
              }),
          ),
        )
    ...
    moveArticle: authenticated((_, { id, parentId }, { dataSources: { db }, currentUserId }) =>
      id === parentId
        ? false
