    ...
    return function (WrappedComponent) { var _a; return _a = /** @class */ (function (_super) {
            ...
            class_1.getInitialProps = function (ctx) {
                return __awaiter(this, void 0, void 0, function () {
                    var signedIn, componentProps, _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                signedIn = auth(ctx);
                                _a = WrappedComponent.getInitialProps;
                                if (!_a) return [3 /*break*/, 2];
                                return [4 /*yield*/, WrappedComponent.getInitialProps(ctx)];
                            case 1:
                                _a = (_b.sent());
                                _b.label = 2;
                            case 2:
                                ...
                                return [2 /*return*/, __assign({}, componentProps)];
                        }
                    });
                });
            };
        ...
        _a.displayName = "withAuth(" + getDisplayName(WrappedComponent) + ")",
        _a.getLayout = WrappedComponent.getLayout,
        _a; };
};
